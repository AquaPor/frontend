      ...
      >
        ...
        <div class="h-[85vh] w-[70%] bg-slate-900 rounded rounded-[2vh] flex ">
            <div class="h-[100%] w-[10%] rounded rounded-[2vh] flex justify-center items-center">
                <div class="h-[95%] w-[80%] bg-slate-800 rounded rounded-[2vh]">
                    <div class="h-[13%] w-[100%] rounded rounded-[2vh] flex justify-center items-center">
                        <div class="h-[70%] w-[70%] bg-slate-800 rounded rounded-[2vh]>
                            flex justify-center items-center 
                            text-3xl text-[#8193a1]">
            ...
            <div class="h-[100%] w-[60%] rounded rounded-[2vh] flex flex-col">
                ...
                <div class="h-[22vh] w-[100%] rounded rounded-[2vh] flex justify-center item-center">
            ...
            <div class="h-[30vh] w-[100%] rounded rounded-[2vh] flex flex-col justify-center items-center ">
                ...
                <div class="h-[90%] w-[95%] bg-slate-700 rounded rounded-[2vh] ">
                    ...
                    <div class="h-[80%] w-[100%] rounded rounded-[2vh] flex">
        ...
        <div class=" h-[100%] w-[30%]  rounded rounded-[2vh] flex justify-center items-center">
            <div class="h-[95%] w-[90%] bg-slate-700 rounded rounded-[2vh]">
